				...
				if (cl != null) {
					...
					switch(cl){
						...
						case HUNTRESS:
							...
							break;
						case HERETIC:
							heroItem.icon(new ItemSprite(ItemSpriteSheet.CANDLE, null));
							heroLoadout.icon(new ItemSprite(ItemSpriteSheet.BONE_BLADE, null));
							heroMisc.icon(new Image(Assets.Environment.TILES_HALLS, 0, 96, 16, 16 ));
							break;
					}
