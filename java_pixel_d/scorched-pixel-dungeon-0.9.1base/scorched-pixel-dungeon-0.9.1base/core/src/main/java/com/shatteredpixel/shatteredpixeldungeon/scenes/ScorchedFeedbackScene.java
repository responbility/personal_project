...
public class ScorchedFeedbackScene extends PixelScene {
	...
	public void create() {
		...
		title.hardlight(Window.SCORCHED_COLOR);
		title.setPos(
				(w - title.width()) / 2f,
				(20 - title.height()) / 2f
		);
		...
		StyledButton link = new StyledButton(Chrome.Type.GREY_BUTTON_TR, Messages.get(this, "feedback_link")){
			@Override
		...
		link.icon(Icons.get(Icons.EXIT));
		link.textColor(Window.SCORCHED_COLOR);
